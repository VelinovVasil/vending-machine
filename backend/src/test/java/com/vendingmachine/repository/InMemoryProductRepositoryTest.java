...
class InMemoryProductRepositoryTest {
    ...
    void replacesTheCatalogWithAnImmutableMapIndexedByProductId() {
        Product coke = new Product(1, "Coke", 150);
        Product water = new Product(2, "Water", 100);
