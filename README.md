...
This repository contains a take-home assignment for a full-stack vending machine application. The backend is built with Spring Boot, while a separate React frontend provides the user interface.
...
8. React acts primarily as the presentation layer and communicates with the backend through REST APIs.
